...
public class ManejadorPista {
    ...
    public static void verGasolina() {
        ...
        System.out.println("\t*********************************");
        System.out.println(TipoPistas.ARENA.toString() + " Necesita de " + TipoPistas.ARENA.getLongitud()
                + " Galones de gasolina");
        System.out.println(TipoPistas.TIERRA.toString() + " Necesita de " + TipoPistas.TIERRA.getLongitud()
                + " Galones de gasolina");
        System.out.println(TipoPistas.CONCRETO.toString() + " Necesita de " + TipoPistas.CONCRETO.getLongitud()
                + " Galones de gasolina");
        System.out.println("");
    }
    ...
    public static void verPistas() {
        ...
        for (int i = 0; i < pistas.length; i++) {
            ...
            System.out.println("Longitud: " + pistas[i].getPistas().getLongitud() + " Coeficiente: "
                    + pistas[i].getPistas().getCoeficiente());
